...
public class MainActivity extends AppCompatActivity {
    ...
    ConstraintLayout CL_liteversion;
    EditText et;
    ImageView ivcrosstv;//cl_score_enter_enternow
    ConstraintLayout Back_SNA, searchnow;
    ConstraintLayout CL_report, CL_searchbuttonpage;
    ConstraintLayout CL_backbar;
...
//6th Initialization
        ...
        //1. Done
        ivcrosstv.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        //3. Done
        CL_liteversion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        EditText et_searchbarvalue = findViewById(R.id.tv);
        ...
        //search button
         searchnow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String str_etValue = et.getText().toString();
                 surl = str_etValue;
                ...
                if(surl.length()>14){
                    ...
                    Toast.makeText(getApplicationContext(), "\"looks like youre supplying an Invalid Url\"", Toast.LENGTH_SHORT).show();
                }
            }
        });

        CL_searchbuttonpage=findViewById(R.id.rightTopMostCL);
        Back_SNA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //if url is valid
                CL_report.setVisibility(View.GONE);
                CL_searchbuttonpage.setVisibility(View.VISIBLE);
                CL_liteversion.setVisibility(View.VISIBLE);
            }
        });
        CL_backbar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //if url is valid
                CL_report.setVisibility(View.GONE);
...
//                Toast.makeText(getApplicationContext(), "Ready to Display !", Toast.LENGTH_LONG).show();
            ...
            if(url_valid_on_bool==true){
                ...
                CL_liteversion.setVisibility(View.GONE);
//Overview      TextView(s).setText(txtString);
                ...
                //Report-visible, searchbarpage-invisible
                CL_report.setVisibility(View.VISIBLE);
//                cl_score_enter_enternow.setVisibility(View.GONE);
